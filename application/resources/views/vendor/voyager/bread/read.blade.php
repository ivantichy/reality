                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @elseif( isset($rowDetails->json) )
                                ...
                                <p>
                                  ...
                                  if( !empty($options)  ) {
                                    if( in_array($row->field, ['specifikace', 'podminky', 'zajemci', 'obrazky', 'dotaz_dulezite', 'dotaz_zaujalo_mne', 'dotaz_chci'])) {
                                      if( is_array($options) ) {
                                    ...
                                    } else if( $row->field == 'vybrane_terminy' ) {
                                      foreach ($options as $key => $value) {
                                        echo '<strong>'.$value->den.':</strong> '.(isset($value->hodina) ? $value->hodina : '').' '.(isset($value->pocet_zajemcu) ? $value->pocet_zajemcu : '').'<br>';
                                      }
                                    } else {
                                      echo '<pre>'.print_r( $options, true ).'</pre>';
                                    }
                                  } else {
                                    echo $dataTypeContent->{$row->field};
                                  }
